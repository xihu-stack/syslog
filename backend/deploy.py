...
PY_FILES = ["api.py", "db.py", "dicts.py", "detector.py", "llm_client.py", "pipeline.py", "profiles.py", "syslog_recv.py", "selfheal.py", "parser_ipg.py", "docscan.py", "massops.py", "storyline.py", "dayreview.py", "timeline.py", "riskboard.py"]
