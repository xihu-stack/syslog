...
SYSTEM_PROMPT = (
    ...
    "  【重点站: BOSS直聘(zhipin)/猎聘(liepin)/前程无忧(51job)/智联招聘(zhaopin)】访问即关注(公司口径:重点站任何访问必须立马关注):分数由系统锚点统一定(单次65/反复3-9次80/高频≥10次85,凌晨+5/跨天+5,封顶95——全系统最高档),你的risk_score仅作参考;窗口含重点站访问→intent判job_seeking,explanation如实写域名+次数+时段+是否跨天。\n"
